...
#define COCOAPODS_POD_AVAILABLE_WTAZoomNavigationController
#define COCOAPODS_VERSION_MAJOR_WTAZoomNavigationController 1
#define COCOAPODS_VERSION_MINOR_WTAZoomNavigationController 0
#define COCOAPODS_VERSION_PATCH_WTAZoomNavigationController 8
